...
function ExperienceAccordion(props) {
  ...
  const faihire = {
    ...
    "borderColor": "#ee3c26",
    "description": "Worked as a Full Stack Software Engineer using LAMP stack and some basics of AWS. Part of my work was to automate the rendering of articles on the live website" +
                  " and also worked on building a platform for hiring candidates in rural regions with poor network availability, reduced the number of requests made to the backend by 60%."
  ...
  const codecamp = {
    ...
    "borderColor": "#FBBD18",
    "description": "Helping children of all ages by providing 1 to 1 help at 3-daya code camps. Responsible for guiding students that were falling behind and explaining key concepts. "+
  ...
  const peaceoneday = {
    ...
    "borderColor": "#196acf",
    "description": "Worked in the testing phase for the development of an mobile application. My role was to test and promote the application and discuss any bugs and improvements. " +
  ...
  const mytutor = {
    ...
    "borderColor": "#ee3c26",
    "description": "Tutored A-Levels, GCSE's and international students. Got a wide curriculum knowledge as different students had different specification. " +
                  "Researched areas of the subject I was not so confident about and leant to be more organised and patient."
  }
